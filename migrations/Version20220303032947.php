 ...
 */
final class Version20220303032947 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE participer_event (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE participer_event_events (participer_event_id INT NOT NULL, events_id INT NOT NULL, INDEX IDX_571C5317125DC864 (participer_event_id), INDEX IDX_571C53179D6A1065 (events_id), PRIMARY KEY(participer_event_id, events_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE participer_event_user (participer_event_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_70D036A3125DC864 (participer_event_id), INDEX IDX_70D036A3A76ED395 (user_id), PRIMARY KEY(participer_event_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
