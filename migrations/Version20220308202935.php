 ...
 */
final class Version20220308202935 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participate_event DROP ticket');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participate_event ADD ticket VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
