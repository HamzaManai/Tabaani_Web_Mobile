 ...
 */
final class Version20220223171724 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE promotion (id INT AUTO_INCREMENT NOT NULL, voyage_id INT NOT NULL, pourcentage_prom DOUBLE PRECISION NOT NULL, UNIQUE INDEX UNIQ_C11D7DD168C9E5AF (voyage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
